...
// types are more flexible than interfaces - best used for primitives/non-objects
...
const d: PhoneNumberDict = {}; // no keys present yet
d.abc; // without an undefined type this non-existent key returns a well-defined value!

// narrow the type with a conditional - non-existent keys will have undefined as their values, which can never pass a check
// undefined can never be truthy
if (d.abc) {
  d.abc;
}
...
if (typeof d.abc === "string") {
  d.abc; // never - this is impossible
}
